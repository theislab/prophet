...
def dataloader_phenotypes(
    ...
    train_set = PhenotypeDataset(
        ...
        if phenotype_embedding is not None
        else None,  # if it's None, None[0] will return error
    ...
    if (
        ...
        train_dataloader = DataLoader(
            train_set, batch_size=batch_size, sampler=train_sampler, num_workers=4
        )
    else:
        train_dataloader = DataLoader(
...
def get_data_by_setting(
    setting, genes_prior=None, cell_lines_prior=None, phenotype_prior=None
):
