...
class DatasetRegistry:
    ...
    def __init__(self):
        ...
        base_data_path = os.getenv("PROPHET_DATA_PATH", "/lustre/groups/ml01/projects/super_rad_project/HF/data_hf")
        base_emb_path = os.getenv("PROPHET_EMB_PATH", "/lustre/groups/ml01/projects/super_rad_project/HF/emb_hf")
        ...
        self.registry = {
            ...
            "Rad": {
                "data_paths": [
                    f"{base_data_path}/Rad_dataset.csv"
                ],
                "iv_embeddings": [
                    f"{base_emb_path}/intervention_embeddings/global_iv_scaledv3.csv"
                ],
    ...
    def get_dataset_config(self, setting: str) -> Dict:
        ...
        if setting not in self.registry:
            ...
            raise ValueError(f"Unknown setting: '{setting}'. Available settings: {available}")
