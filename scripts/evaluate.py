...
def main():
    ...
    parser.add_argument("--embeddings", type=str, nargs='+', required=True, help="Embedding paths")
    parser.add_argument("--output", type=str, default="./evaluation_results.csv", help="Output file")
